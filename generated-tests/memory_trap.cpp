...
const string wasm_str_memory_trap_0 = base_dir + "/" + WASM_SPEC_TESTS_DIR + "/generated-tests/wasms/memory_trap.0.wasm";
...
const string wasm_str_memory_trap_1 = base_dir + "/" + WASM_SPEC_TESTS_DIR + "/generated-tests/wasms/memory_trap.1.wasm";
