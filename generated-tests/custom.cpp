...
const string wasm_str_custom_0 = base_dir + "/" + WASM_SPEC_TESTS_DIR + "/generated-tests/wasms/custom.0.wasm";
...
const string wasm_str_custom_1 = base_dir + "/" + WASM_SPEC_TESTS_DIR + "/generated-tests/wasms/custom.1.wasm";
...
const string wasm_str_custom_2 = base_dir + "/" + WASM_SPEC_TESTS_DIR + "/generated-tests/wasms/custom.2.wasm";
